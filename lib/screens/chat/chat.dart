...
import 'package:newimovers/services/message/chatListService.dart';
          ...
          if (snapshot.hasData) {
            ...
            return ListView.builder(
              ...
              itemBuilder: (context, index) => MessageItem(
                  ...
                  userId: chatParams.fromUser.username!,
  ...
  Future<void> onSendMessage(String content, int type) async {
    if (content.trim() != '') {
      messageService.onSendMessage(
          ...
          Message(
              idFrom: chatParams.fromUser.username!,
              idTo: chatParams.toUser,
              timestamp: DateTime.now().millisecondsSinceEpoch.toString(),
              content: content,
              type: type));
      await ChatListService(chatParams).saveChat(chatParams);
